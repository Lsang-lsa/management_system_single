package com.lsang.framework.web.domain;

import java.net.UnknownHostException;
import java.util.LinkedList;
import java.util.List;
import java.util.Properties;
import com.lsang.common.utils.Arith;
import com.lsang.common.utils.ip.IpUtils;
import com.lsang.framework.web.domain.server.Cpu;
import com.lsang.framework.web.domain.server.Jvm;
import com.lsang.framework.web.domain.server.Mem;
import com.lsang.framework.web.domain.server.Sys;
import com.lsang.framework.web.domain.server.SysFile;
